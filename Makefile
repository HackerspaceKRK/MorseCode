...
CFLAGS = -O2 -gstabs -std=gnu99  -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums  -Wall -Wstrict-prototypes  -Wa,-adhlns=$(<:.c=.lst)  $(patsubst %,-I%,$(EXTRAINCDIRS))
...
#AVRDUDE_FLAGS += -U lfuse:w:0xe1:m -U hfuse:w:0xd9:m
